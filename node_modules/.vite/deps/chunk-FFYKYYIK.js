import {
  ...
  useTimeout
} from "./chunk-VYF5BGHX.js";
import {
  getUnit,
  toUnitless
} from "./chunk-QF7QQIML.js";
import {
...
import {
  ...
  useForkRef_default,
  useId_default
} from "./chunk-YJA7RVH5.js";
import {
  useDefaultProps
} from "./chunk-EA4UK4EO.js";
import {
  alpha,
  clsx_default,
  composeClasses,
...
var Chip = React10.forwardRef(function Chip2(inProps, ref) {
  ...
  return (0, import_jsx_runtime9.jsxs)(RootSlot, {
    as: component,
    ...rootProps,
    children: [avatar || icon, (0, import_jsx_runtime9.jsx)(LabelSlot, {
      ...labelProps,
      children: label
    }), deleteIcon]
  });
...
var Backdrop = React16.forwardRef(function Backdrop2(inProps, ref) {
  ...
  return (0, import_jsx_runtime13.jsx)(TransitionSlot, {
    in: open,
    timeout: transitionDuration,
    ...other,
    ...transitionProps,
    children: (0, import_jsx_runtime13.jsx)(RootSlot, {
      "aria-hidden": true,
      ...rootProps,
      classes,
      ref,
...
var Button = React19.forwardRef(function Button2(inProps, ref) {
  ...
  const loadingId = useId_default(idProp);
  const loadingIndicator = loadingIndicatorProp ?? (0, import_jsx_runtime14.jsx)(CircularProgress_default, {
    "aria-labelledby": loadingId,
    color: "inherit",
    size: 16
  });
  ...
  const startIcon = (startIconProp || loading && loadingPosition === "start") && (0, import_jsx_runtime14.jsx)(ButtonStartIcon, {
    className: classes.startIcon,
    ownerState,
    children: startIconProp || (0, import_jsx_runtime14.jsx)(ButtonLoadingIconPlaceholder, {
      className: classes.loadingIconPlaceholder,
      ownerState
    })
  });
  const endIcon = (endIconProp || loading && loadingPosition === "end") && (0, import_jsx_runtime14.jsx)(ButtonEndIcon, {
    className: classes.endIcon,
    ownerState,
    children: endIconProp || (0, import_jsx_runtime14.jsx)(ButtonLoadingIconPlaceholder, {
      className: classes.loadingIconPlaceholder,
      ownerState
    })
  });
  ...
  const loader = typeof loading === "boolean" ? (
    ...
    (0, import_jsx_runtime14.jsx)("span", {
      ...
      children: loading && (0, import_jsx_runtime14.jsx)(ButtonLoadingIndicator, {
        className: classes.loadingIndicator,
        ownerState,
  ...
  return (0, import_jsx_runtime14.jsxs)(ButtonRoot, {
    ownerState,
...
true ? Button.propTypes = {
   ...
   * @default 'center'
   */
  loadingPosition: import_prop_types14.default.oneOf(["center", "end", "start"]),
  /**
   * The size of the component.
   * `small` is equivalent to the dense button styling.
   * @default 'medium'
...
function FocusTrap(props) {
  ...
  return (0, import_jsx_runtime15.jsxs)(React20.Fragment, {
...
var Divider = React23.forwardRef(function Divider2(inProps, ref) {
  ...
  return (0, import_jsx_runtime17.jsx)(DividerRoot, {
    as: component,
    className: clsx_default(classes.root, className),
    role,
    ref,
    ...
    ...other,
    children: children ? (0, import_jsx_runtime17.jsx)(DividerWrapper, {
...
var FormHelperText = React26.forwardRef(function FormHelperText2(inProps, ref) {
  ...
  return (0, import_jsx_runtime20.jsx)(FormHelperTextRoot, {
    as: component,
    className: clsx_default(classes.root, className),
    ref,
    ...other,
...
var InputAdornment = React29.forwardRef(function InputAdornment2(inProps, ref) {
  ...
  return (0, import_jsx_runtime23.jsx)(FormControlContext_default.Provider, {
    value: null,
    children: (0, import_jsx_runtime23.jsx)(InputAdornmentRoot, {
      as: component,
      ownerState,
      className: clsx_default(classes.root, className),
      ref,
      ...other,
      children: typeof children === "string" && !disableTypography ? (0, import_jsx_runtime23.jsx)(Typography_default, {
        color: "textSecondary",
        children
      }) : (0, import_jsx_runtime23.jsxs)(React29.Fragment, {
...
var InputLabel = React30.forwardRef(function InputLabel2(inProps, ref) {
  ...
  return (0, import_jsx_runtime24.jsx)(InputLabelRoot, {
    "data-shrink": shrink,
    ref,
    className: clsx_default(classes.root, className),
    ...other,
...
var List = React32.forwardRef(function List2(inProps, ref) {
  ...
  return (0, import_jsx_runtime25.jsx)(ListContext_default.Provider, {
    value: context,
    children: (0, import_jsx_runtime25.jsxs)(ListRoot, {
      as: component,
      className: clsx_default(classes.root, className),
      ref,
      ownerState,
...
var ListItemIcon = React33.forwardRef(function ListItemIcon2(inProps, ref) {
  const props = useDefaultProps({
    props: inProps,
    name: "MuiListItemIcon"
  });
...
var ListItemText = React34.forwardRef(function ListItemText2(inProps, ref) {
  const props = useDefaultProps({
    props: inProps,
    name: "MuiListItemText"
  });
  ...
  const {
    dense
  } = React34.useContext(ListContext_default);
...
var MenuList = React35.forwardRef(function MenuList2(props, ref) {
  ...
  const items = React35.Children.map(children, (child, index) => {
...
var Menu = React37.forwardRef(function Menu2(inProps, ref) {
  ...
  let activeItemIndex = -1;
  React37.Children.map(children, (child, index) => {
...
var OutlinedInput = React40.forwardRef(function OutlinedInput2(inProps, ref) {
  ...
  const [NotchedSlot, notchedProps] = useSlot("notchedOutline", {
    ...
    additionalProps: {
      label: label != null && label !== "" && fcs.required ? (0, import_jsx_runtime33.jsxs)(React40.Fragment, {
        children: [label, " ", "*"]
      }) : label
    }
  });
  return (0, import_jsx_runtime33.jsx)(InputBase_default, {
    ...
    slotProps,
    renderSuffix: (state) => (0, import_jsx_runtime33.jsx)(NotchedSlot, {
      ...notchedProps,
...
true ? OutlinedInput.propTypes = {
  ...
  slotProps: import_prop_types33.default.shape({
    ...
    notchedOutline: import_prop_types33.default.oneOfType([import_prop_types33.default.func, import_prop_types33.default.object]),
  ...
  slots: import_prop_types33.default.shape({
    input: import_prop_types33.default.elementType,
    notchedOutline: import_prop_types33.default.elementType,
    root: import_prop_types33.default.elementType
  }),
  /**
   * Start `InputAdornment` for this component.
...
var NativeSelectInput = React41.forwardRef(function NativeSelectInput2(props, ref) {
  ...
  return (0, import_jsx_runtime34.jsxs)(React41.Fragment, {
...
var Select = React44.forwardRef(function Select2(inProps, ref) {
  ...
  return (0, import_jsx_runtime37.jsx)(React44.Fragment, {
    children: React44.cloneElement(InputComponent, {
...
var Tab = React46.forwardRef(function Tab2(inProps, ref) {
  ...
  return (0, import_jsx_runtime39.jsxs)(TabRoot, {
    ...
    ...other,
    children: [iconPosition === "top" || iconPosition === "start" ? (0, import_jsx_runtime39.jsxs)(React46.Fragment, {
      children: [icon, label]
    }) : (0, import_jsx_runtime39.jsxs)(React46.Fragment, {
      children: [label, icon]
    }), indicator]
  });
});
...
var TabScrollButton = React49.forwardRef(function TabScrollButton2(inProps, ref) {
  const props = useDefaultProps({
    props: inProps,
    name: "MuiTabScrollButton"
  });
...
function ScrollbarSize(props) {
  ...
  const scrollbarHeight = React50.useRef();
...
var Tabs = React51.forwardRef(function Tabs2(inProps, ref) {
  ...
  const getConditionalElements = () => {
    ...
    conditionalElements2.scrollbarSizeListener = scrollable ? (0, import_jsx_runtime44.jsx)(ScrollbarSlot, {
      ...scrollbarSlotProps,
      onChange: handleScrollbarSizeChange
    }) : null;
    const scrollButtonsActive = displayStartScroll || displayEndScroll;
    const showScrollButtons = scrollable && (scrollButtons === "auto" && scrollButtonsActive || scrollButtons === true);
    conditionalElements2.scrollButtonStart = showScrollButtons ? (0, import_jsx_runtime44.jsx)(ScrollButtonsSlot, {
      direction: isRtl ? "right" : "left",
      onClick: handleStartScrollClick,
      disabled: !displayStartScroll,
      ...scrollButtonSlotProps
    }) : null;
    conditionalElements2.scrollButtonEnd = showScrollButtons ? (0, import_jsx_runtime44.jsx)(ScrollButtonsSlot, {
  ...
  const indicator = (0, import_jsx_runtime44.jsx)(IndicatorSlot, {
    ...indicatorSlotProps
  });
  let childIndex = 0;
  ...
  return (0, import_jsx_runtime44.jsxs)(RootSlot, {
    ...rootSlotProps,
    children: [conditionalElements.scrollButtonStart, conditionalElements.scrollbarSizeListener, (0, import_jsx_runtime44.jsxs)(ScrollerSlot, {
      ...scrollerSlotProps,
      children: [(0, import_jsx_runtime44.jsx)(ListSlot, {
        "aria-label": ariaLabel,
        "aria-labelledby": ariaLabelledBy,
...
true ? Tabs.propTypes = {
  ...
  slotProps: import_prop_types41.default.shape({
    ...
    scrollbar: import_prop_types41.default.oneOfType([import_prop_types41.default.func, import_prop_types41.default.object]),
    scrollButtons: import_prop_types41.default.oneOfType([import_prop_types41.default.func, import_prop_types41.default.object]),
    scroller: import_prop_types41.default.oneOfType([import_prop_types41.default.func, import_prop_types41.default.object]),
  ...
  slots: import_prop_types41.default.shape({
    ...
    scrollbar: import_prop_types41.default.elementType,
    scrollButtons: import_prop_types41.default.elementType,
    scroller: import_prop_types41.default.elementType,
...
//# sourceMappingURL=chunk-FFYKYYIK.js.map
